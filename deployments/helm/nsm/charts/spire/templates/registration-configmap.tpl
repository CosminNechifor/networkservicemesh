      ...
      "entries": [
        ...
        },
        {
          "selectors": [
            {
              "type": "k8s",
              "value": "sa:proxy-nsmgr-acc"
            }
          ],
          "spiffe_id": "spiffe://{{ .Values.trustDomain }}/proxy-nsmgr",
          "parent_id": "spiffe://{{ .Values.trustDomain }}/spire-agent"
        },
        {
          "selectors": [
            {
              "type": "k8s",
              "value": "sa:crossconnect-monitor-acc"
            }
          ],
          "spiffe_id": "spiffe://{{ .Values.trustDomain }}/crossconnect-monitor",
          "parent_id": "spiffe://{{ .Values.trustDomain }}/spire-agent"
        },
        {
          "selectors": [
        ...
        },
        {
          ...
          "spiffe_id": "spiffe://{{ .Values.trustDomain }}/nsmrs",
          "parent_id": "spiffe://{{ .Values.trustDomain }}/spire-agent"
        }
      ]
    }
